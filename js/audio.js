...
const sfx = {
  ...
  yay: () => { [523, 659, 784, 1047, 1318, 1568, 2093].forEach((f, i) => tone(f, .25, 'sine', .1, i * .1)); },
  tada: () => { tone(523, 0.2, 'square', 0.1); tone(523, 0.1, 'square', 0.1, 0.25); tone(880, 0.4, 'triangle', 0.15, 0.4); },
